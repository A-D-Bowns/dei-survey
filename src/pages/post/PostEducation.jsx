// src/pages/post/PostEducation.jsx
...
export default function PostEducation() {
  ...
  const value = answers.demo_education ?? "";
      ...
      <div className="mx-auto max-w-3xl px-4 pb-16 pt-10 md:px-6">
        <header className="mb-8">
          <h1 className="text-3xl font-semibold tracking-tight text-gray-900">
            Final Questions — Education
          </h1>
          <p className="text-sm text-gray-500">
            These help us interpret results across different backgrounds.
          </p>
        </header>

        {/* Post flow: Education(1), Employment(2), Income(3), Zip(4), Device/Browser(5), Thanks(6) */}
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm md:p-8">
              ...
              return (
                ...
                >
                  <input
                    ...
                    checked={active}
                    onChange={() => setAnswer("demo_education", opt)}
                  />
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <button
              onClick={() => canContinue && nav("/post/employment")}
